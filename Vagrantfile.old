...
#      ansible.playbook = "deploy_dockerRH7.yml"
##     ansible.groups = {
...
# end
  config.vm.define "dockerRH7" do |dockerRH7|
    dockerRH7.vm.box = "clouddood/RH7.5_baserepo"
    dockerRH7.vm.hostname = "dockerRH7"
    dockerRH7.vm.network "private_network", ip: "192.168.60.157"
#   dockerRH7.vm.network "private_network", ip: "192.168.60.157", nic_type: "virtio"
    dockerRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.157 dockerRH7.local dockerRH7' >> /etc/hosts"

##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update

    # Default
    dockerRH7.vm.provision "main", type: "ansible" do |ansible|
      ansible.playbook = "deploy_dockerRH7_DEV.local.yml"
#     ansible.playbook = "deploy_dockerRH7_DEV.local.yml"
#     ansible.playbook = "deploy_sasTestRH7.yml"
    ...
    # Update
#   dockerRH7.vm.provision "update", type: "ansible" do |ansible|
